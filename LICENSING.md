# Install Tools — Licensing

Install Tools uses a **dual-license model**: open source for the community,
...
1. Use Install Tools commercially with **>50 users** and **>$5M revenue/year**
2. Distribute Install Tools inside a product **without** releasing your source under AGPLv3
3. Offer Install Tools as a **hosted/managed service** without releasing modifications
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer Install Tools
...
Open an issue: https://github.com/egkristi/install-tools/issues
